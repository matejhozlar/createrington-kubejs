...
ServerEvents.tags("block", (event) => {
  ...
  event.add("silentgear:mineable/paxel", "#mcwwindows:mosaic_glass");
  event.add("minecraft:mineable/pickaxe", "#chipped:glass_pane");
  event.add("silentgear:mineable/paxel", "#chipped:glass_pane");
});
