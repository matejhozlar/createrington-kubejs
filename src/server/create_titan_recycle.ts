...
ServerEvents.recipes((event)=>{
    ...
    event.stonecutting('northstar:titanium_sheetmetal_vertical_slab', 'northstar:titanium_sheetmetal_slab');
    event.stonecutting('northstar:titanium_plating_vertical_slab', 'northstar:titanium_plating_slab');
    event.stonecutting('northstar:titanium_sheetmetal_slab', 'northstar:titanium_sheetmetal_vertical_slab');
    event.stonecutting('northstar:titanium_plating_slab', 'northstar:titanium_plating_vertical_slab');
    // Stairs back to Full Blocks
    event.stonecutting('northstar:titanium_plating', 'northstar:titanium_plating_stairs');
