...
import { $ProcessingRecipeSchema$TimedProcessingRecipeKube, $ProcessingRecipeSchema$ProcessingRecipeKube } from "@package/io/github/hadron13/rubberworks/compat/kubejs/schemas";
...
declare module "@side-only/server/events/recipes" {
    ...
    export class DocumentedRecipes {
        ...
        rubberworks: {
            sapping(results: $List_<$FluidStack_ | $ProcessingOutput>, ingredients: $List_<$SizedFluidIngredient | $SizedIngredient_>): Rubberworks$Sapping;
            compressing(results: $List_<$FluidStack_ | $ProcessingOutput>, ingredients: $List_<$SizedFluidIngredient | $SizedIngredient_>, processingTime?: number, heatRequirement?: $HeatCondition_): Rubberworks$Compressing;
        }
    }
    ...
    export class Rubberworks$Sapping extends $ProcessingRecipeSchema$ProcessingRecipeKube {
        results(results: $List_<$FluidStack_ | $ProcessingOutput>): this;
        ingredients(ingredients: $List_<$SizedFluidIngredient | $SizedIngredient_>): this;
    }
    ...
    export class Rubberworks$Compressing extends $ProcessingRecipeSchema$TimedProcessingRecipeKube {
        results(results: $List_<$FluidStack_ | $ProcessingOutput>): this;
        ingredients(ingredients: $List_<$SizedFluidIngredient | $SizedIngredient_>): this;
