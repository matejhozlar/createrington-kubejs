...
import { $LootEntityNumberProviderType } from "@package/petrolpark/mc/library/core/data/numberProvider/entity";
import { $Schedule, $Activity } from "@package/net/minecraft/world/entity/schedule";
import { $AbilityType } from "@package/com/furiusmax/bjornlib/ability";
...
import { $IScratchScope } from "@package/petrolpark/mc/library/core/scratch/environment/variable";
import { $StructureType, $Structure, $StructureSet } from "@package/net/minecraft/world/level/levelgen/structure";
import { $SprinkleActionType, $Sprinkler } from "@package/com/possible_triangle/sliceanddice/api/sprinkler";
import { $IScratchExpression$Type } from "@package/petrolpark/mc/library/core/scratch/symbol/expression";
...
import { $IngredientRandomizerType } from "@package/petrolpark/mc/library/core/data/recipe/ingredient/randomizer";
...
import { $IAdvancedIngredientType } from "@package/petrolpark/mc/library/core/data/recipe/ingredient/advanced";
import { $StringProviderType } from "@package/petrolpark/mc/library/core/data/stringProvider";
import { $DimensionType } from "@package/net/minecraft/world/level/dimension";
import { $StatType } from "@package/net/minecraft/stats";
import { $LootItemStackNumberProviderType } from "@package/petrolpark/mc/library/core/data/numberProvider/itemStack";
import { $ITradeListingReference$Type } from "@package/petrolpark/mc/library/experimental/trade";
...
import { $MandrelAnimationType } from "@package/petrolpark/mc/library/compat/create/shared/content/processing/mandrel/animation";
...
import { $TransferKubeEvent, $PreTransferKubeEvent } from "@package/com/breakinblocks/aeroportals/compat/kubejs";
import { $RecipeMappingRegistry, $RecipeSchemaRegistry } from "@package/dev/latvian/mods/kubejs/recipe/schema";
import { $Flag } from "@package/petrolpark/mc/library/core/flags";
import { $HolderSetType } from "@package/net/neoforged/neoforge/registries/holdersets";
import { $CogwheelChainType } from "@package/com/kipti/bnb/content/kinetics/cogwheel_chain/types";
...
import { $BogglePatternGeneratorType } from "@package/petrolpark/mc/library/core/data/recipe/bogglePattern/generator";
...
import { $IRewardInfo$Type } from "@package/petrolpark/mc/library/core/data/reward/info";
import { $NavigationTarget } from "@package/dev/simulated_team/simulated/content/blocks/nav_table/navigation_target";
import { $IScratchBlock$Type } from "@package/petrolpark/mc/library/core/scratch/symbol/block";
...
import { $RewardGeneratorType, $IRewardGenerator } from "@package/petrolpark/mc/library/core/data/reward/generator";
...
import { $RecipeRequirementType } from "@package/com/oierbravo/mechanicals/foundation/recipe";
...
import { $Badge } from "@package/petrolpark/mc/library/core/badge";
import { $MapCodec } from "@package/com/mojang/serialization";
import { $DecayProductType } from "@package/petrolpark/mc/library/core/world/item/decay/product";
...
import { $Quest } from "@package/com/furiusmax/bjornlib/quest/types";
...
import { $RestaurantOrderGenerator } from "@package/petrolpark/mc/library/core/world/restaurant/order";
...
import { $LootTableModifierType, $LootPoolEntryModifierType, $LootTableModification } from "@package/petrolpark/mc/library/core/data/loot/modifier";
...
import { $IDoughTopping, $IDoughTopping$Type } from "@package/petrolpark/mc/library/compat/create/core/world/dough/topping";
...
import { $BogglePattern } from "@package/petrolpark/mc/library/core/data/recipe/bogglePattern";
import { $CustomSituationalMusic } from "@package/dev/eriksonn/aeronautics/api";
import { $WeatherCondition } from "@package/com/possible_triangle/atmosphere/api/v1";
...
import { $ITeamReward$Type } from "@package/petrolpark/mc/library/core/data/reward/team";
import { $CommandRegistryKubeEvent } from "@package/dev/latvian/mods/kubejs/command";
import { $AnimalMoodModifier } from "@package/petrolpark/mc/library/core/world/entity/animal/mood";
import { $IReward, $IReward$Type } from "@package/petrolpark/mc/library/core/data/reward";
...
import { $BlockDropsKubeEvent, $BlockPlacedKubeEvent, $BlockRightClickedKubeEvent, $BlockPickedKubeEvent, $DetectorBlockKubeEvent, $RandomTickKubeEvent, $FarmlandTrampledKubeEvent, $BlockLeftClickedKubeEvent, $BlockBrokenKubeEvent, $BlockStoppedFallingKubeEvent, $BlockStartedFallingKubeEvent } from "@package/dev/latvian/mods/kubejs/block";
import { $PanelType } from "@package/net/liukrast/deployer/lib/logistics/board";
import { $LootTeamNumberProviderType } from "@package/petrolpark/mc/library/core/data/numberProvider/team";
import { $DoughCut, $IDoughType } from "@package/petrolpark/mc/library/compat/create/core/world/dough";
import { $LootItemFunctionType } from "@package/net/minecraft/world/level/storage/loot/functions";
import { $ITeam$ProviderType } from "@package/petrolpark/mc/library/core/world/entity/player/team";
import { $VillagerType, $VillagerProfession } from "@package/net/minecraft/world/entity/npc";
import { $IEntityReward$Type } from "@package/petrolpark/mc/library/core/data/reward/entity";
...
import { $IScratchClassType } from "@package/petrolpark/mc/library/core/scratch/classes";
...
import { $SulfurCubeArchetype } from "@package/com/blackgear/vanillabackport/common/level/entities/sulfurcube";
import { $KJSBlockUIMenuType$BlockUIEventJS, $KJSPlayerUIMenuType$PlayerUIEventJS, $KJSHeldItemUIMenuType$ItemUIEventJS } from "@package/com/lowdragmc/lowdraglib2/integration/kjs/ui";
import { $Restaurant } from "@package/petrolpark/mc/library/core/world/restaurant";
...
declare global {
    ...
    namespace ServerEvents {
        ...
        function tags(type: "petrolpark:advanced_ingredient_type", handler: ((event: TagEvent<$IAdvancedIngredientType<any>>) => void)): void;
        function tags(type: "petrolpark:decay_product_type", handler: ((event: TagEvent<$DecayProductType>) => void)): void;
        function tags(type: "worldgen/world_preset", handler: ((event: TagEvent<$WorldPreset>) => void)): void;
        function tags(type: "bits_n_bobs:cogwheel_chain_type", handler: ((event: TagEvent<$CogwheelChainType>) => void)): void;
        ...
        function tags(type: "petrolpark:reward_generator_type", handler: ((event: TagEvent<$RewardGeneratorType>) => void)): void;
        ...
        function tags(type: "petrolpark:dough/topping", handler: ((event: TagEvent<$IDoughTopping>) => void)): void;
        ...
        function tags(type: "petrolpark:badge", handler: ((event: TagEvent<$Badge>) => void)): void;
        ...
        function tags(type: "petrolpark:boggle_pattern", handler: ((event: TagEvent<$BogglePattern>) => void)): void;
        ...
        function tags(type: "bjornlib:bjorn_ability", handler: ((event: TagEvent<$AbilityType>) => void)): void;
        ...
        function tags(type: "petrolpark:animal_mood_modifier", handler: ((event: TagEvent<$AnimalMoodModifier>) => void)): void;
        ...
        function tags(type: "petrolpark:scratch_environment_type", handler: ((event: TagEvent<$IScratchEnvironment$Type<any>>) => void)): void;
        ...
        function tags(type: "deployer:stock_inventory", handler: ((event: TagEvent<$StockInventoryType<any, any, any>>) => void)): void;
        function tags(type: "deployer:panel_connections", handler: ((event: TagEvent<$PanelConnection<any>>) => void)): void;
        ...
        function tags(type: "petrolpark:reward_type", handler: ((event: TagEvent<$IReward$Type>) => void)): void;
        ...
        function tags(type: "petrolpark:dough/ingredient_type", handler: ((event: TagEvent<$IAdvancedIngredientType<any>>) => void)): void;
        ...
        function tags(type: "petrolpark:dough/type", handler: ((event: TagEvent<$IDoughType<any>>) => void)): void;
        ...
        function tags(type: "petrolpark:dough/cut", handler: ((event: TagEvent<$DoughCut>) => void)): void;
        function tags(type: "petrolpark:restaurant/offer_generator", handler: ((event: TagEvent<$RestaurantOrderGenerator>) => void)): void;
        function tags(type: "petrolpark:scratch_scope", handler: ((event: TagEvent<$IScratchScope>) => void)): void;
        ...
        function tags(type: "petrolpark:advanced_fluid_ingredient_type", handler: ((event: TagEvent<$IAdvancedIngredientType<any>>) => void)): void;
        function tags(type: "petrolpark:ingredient_randomizer_type", handler: ((event: TagEvent<$IngredientRandomizerType>) => void)): void;
        function tags(type: "petrolpark:boggle_pattern_generator_type", handler: ((event: TagEvent<$BogglePatternGeneratorType>) => void)): void;
        ...
        function tags(type: "petrolpark:loot_entity_number_provider_type", handler: ((event: TagEvent<$LootEntityNumberProviderType>) => void)): void;
        function tags(type: "petrolpark:mandrel_animation_type", handler: ((event: TagEvent<$MandrelAnimationType>) => void)): void;
        ...
        function tags(type: "petrolpark:team_reward_type", handler: ((event: TagEvent<$ITeamReward$Type>) => void)): void;
        function tags(type: "petrolpark:scratch_block_type", handler: ((event: TagEvent<$IScratchBlock$Type<any>>) => void)): void;
        ...
        function tags(type: "bjornlib:quests", handler: ((event: TagEvent<$Quest<any>>) => void)): void;
        function tags(type: "pos_rule_test", handler: ((event: TagEvent<$PosRuleTestType<any>>) => void)): void;
        function tags(type: "sliceanddice:sprinkle_action", handler: ((event: TagEvent<$SprinkleActionType<any>>) => void)): void;
        function tags(type: "sliceanddice:sprinkler", handler: ((event: TagEvent<$Sprinkler<any>>) => void)): void;
        function tags(type: "petrolpark:loot_table_modification", handler: ((event: TagEvent<$LootTableModification>) => void)): void;
        function tags(type: "trim_material", handler: ((event: TagEvent<$TrimMaterial>) => void)): void;
        function tags(type: "petrolpark:reward_info_type", handler: ((event: TagEvent<$IRewardInfo$Type>) => void)): void;
        function tags(type: "petrolpark:loot_item_stack_number_provider_type", handler: ((event: TagEvent<$LootItemStackNumberProviderType>) => void)): void;
        ...
        function tags(type: "petrolpark:scratch_class_type", handler: ((event: TagEvent<$IScratchClassType>) => void)): void;
        function tags(type: "vanillabackport:sulfur_cube_archetypes", handler: ((event: TagEvent<$SulfurCubeArchetype>) => void)): void;
        ...
        function tags(type: "petrolpark:reward_generator", handler: ((event: TagEvent<$IRewardGenerator>) => void)): void;
        ...
        function tags(type: "atmosphere:weather_condition", handler: ((event: TagEvent<$WeatherCondition>) => void)): void;
        ...
        function tags(type: "petrolpark:team_provider_type", handler: ((event: TagEvent<$ITeam$ProviderType>) => void)): void;
        function tags(type: "rule_block_entity_modifier", handler: ((event: TagEvent<$RuleBlockEntityModifierType<any>>) => void)): void;
        function tags(type: "petrolpark:scratch_expression_type", handler: ((event: TagEvent<$IScratchExpression$Type<any>>) => void)): void;
        ...
        function tags(type: "petrolpark:restaurant", handler: ((event: TagEvent<$Restaurant>) => void)): void;
        ...
        function tags(type: "petrolpark:dough/topping_type", handler: ((event: TagEvent<$IDoughTopping$Type<any>>) => void)): void;
        function tags(type: "mechanicals:requirement", handler: ((event: TagEvent<$RecipeRequirementType<any>>) => void)): void;
        ...
        function tags(type: "deployer:panels", handler: ((event: TagEvent<$PanelType<any>>) => void)): void;
        function tags(type: "worldgen/carver", handler: ((event: TagEvent<$WorldCarver<any>>) => void)): void;
        function tags(type: "petrolpark:trade_listing_reference_type", handler: ((event: TagEvent<$ITradeListingReference$Type>) => void)): void;
        ...
        function tags(type: "petrolpark:string_provider_type", handler: ((event: TagEvent<$StringProviderType>) => void)): void;
        function tags(type: "petrolpark:reward", handler: ((event: TagEvent<$IReward>) => void)): void;
        ...
        function tags(type: "petrolpark:entity_reward_type", handler: ((event: TagEvent<$IEntityReward$Type>) => void)): void;
        function tags(type: "stat_type", handler: ((event: TagEvent<$StatType<any>>) => void)): void;
        function tags(type: "petrolpark:loot_team_number_provider_type", handler: ((event: TagEvent<$LootTeamNumberProviderType>) => void)): void;
        ...
        function tags(type: "petrolpark:loot_pool_entry_modifier_type", handler: ((event: TagEvent<$LootPoolEntryModifierType>) => void)): void;
        ...
        function tags(type: "petrolpark:loot_table_modifier_type", handler: ((event: TagEvent<$LootTableModifierType>) => void)): void;
        function tags(type: "item_sub_predicate_type", handler: ((event: TagEvent<$ItemSubPredicate$Type<any>>) => void)): void;
        function tags(type: "petrolpark:flag", handler: ((event: TagEvent<$Flag>) => void)): void;
    ...
    namespace AeroPortalsEvents {
        function transfer(handler: ((event: $TransferKubeEvent) => void)): void;
        function preTransfer(handler: ((event: $PreTransferKubeEvent) => void)): void;
    }
