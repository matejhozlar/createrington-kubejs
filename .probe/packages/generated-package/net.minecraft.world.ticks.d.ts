 ...
 * types for convenience unless there's a naming conflict.
 */
export type $SavedTick$$Type<T> = ({"priority"?: $TickPriority$$Type, "type"?: T, "delay"?: integer, "pos"?: $BlockPos$$Type}) | ([priority?: $TickPriority$$Type, type?: T, delay?: integer, pos?: $BlockPos$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ScheduledTick$$Type<T> = ({"priority"?: $TickPriority$$Type, "pos"?: $BlockPos$$Type, "type"?: T, "subTickOrder"?: long, "triggerTick"?: long}) | ([priority?: $TickPriority$$Type, pos?: $BlockPos$$Type, type?: T, subTickOrder?: long, triggerTick?: long]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
