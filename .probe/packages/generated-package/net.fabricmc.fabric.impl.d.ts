...
export interface $AccessChunkRendererRegion$$Interface {
}

export class $AccessChunkRendererRegion implements $AccessChunkRendererRegion$$Interface {
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $AccessChunkRendererRegion$$Original = $AccessChunkRendererRegion;}
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $TerrainRenderContext$$Original = $TerrainRenderContext;}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $AttachmentTargetInfo$Type$$Type<T> = ({"packetCodec"?: $StreamCodec$$Type<($ByteBuf$$Type), ($AttachmentTargetInfo$$Type<(T)>)>, "id"?: byte}) | ([packetCodec?: $StreamCodec$$Type<($ByteBuf$$Type), ($AttachmentTargetInfo$$Type<(T)>)>, id?: byte]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
