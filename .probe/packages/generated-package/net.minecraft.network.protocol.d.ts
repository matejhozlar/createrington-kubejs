 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClientboundMapItemDataPacket$$Type = ({"colorPatch"?: ($MapItemSavedData$MapPatch$$Type)?, "scale"?: byte, "mapId"?: $MapId$$Type, "locked"?: boolean, "decorations"?: ($List$$Type<($MapDecoration$$Type)>)?}) | ([colorPatch?: ($MapItemSavedData$MapPatch$$Type)?, scale?: byte, mapId?: $MapId$$Type, locked?: boolean, decorations?: ($List$$Type<($MapDecoration$$Type)>)?]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClientboundResourcePackPushPacket$$Type = ({"prompt"?: ($Component$$Type)?, "url"?: StringJS, "hash"?: StringJS, "required"?: boolean, "id"?: $UUID$$Type}) | ([prompt?: ($Component$$Type)?, url?: StringJS, hash?: StringJS, required?: boolean, id?: $UUID$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $BeeDebugPayload$BeeInfo$$Type = ({"goals"?: $Set$$Type<(StringJS)>, "travelTicks"?: integer, "flowerPos"?: $BlockPos$$Type, "pos"?: $Vec3$$Type, "hivePos"?: $BlockPos$$Type, "blacklistedHives"?: $List$$Type<($BlockPos$$Type)>, "id"?: integer, "path"?: $Path$$Type, "uuid"?: $UUID$$Type}) | ([goals?: $Set$$Type<(StringJS)>, travelTicks?: integer, flowerPos?: $BlockPos$$Type, pos?: $Vec3$$Type, hivePos?: $BlockPos$$Type, blacklistedHives?: $List$$Type<($BlockPos$$Type)>, id?: integer, path?: $Path$$Type, uuid?: $UUID$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ServerboundContainerSlotStateChangedPacket$$Type = ({"containerId"?: integer, "slotId"?: integer, "newState"?: boolean}) | ([containerId?: integer, slotId?: integer, newState?: boolean]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
public static "getMaxPayloadSize$fabric_data_attachment_api_v1_$md$1ae6d3$0"(): integer
public "isSkippable"(): boolean
...
get "maxPayloadSize$fabric_data_attachment_api_v1_$md$1ae6d3$0"(): integer
get "skippable"(): boolean
get "terminal"(): boolean
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $HiveDebugPayload$HiveInfo$$Type = ({"sedated"?: boolean, "pos"?: $BlockPos$$Type, "occupantCount"?: integer, "hiveType"?: StringJS, "honeyLevel"?: integer}) | ([sedated?: boolean, pos?: $BlockPos$$Type, occupantCount?: integer, hiveType?: StringJS, honeyLevel?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClientboundSetScorePacket$$Type = ({"numberFormat"?: ($NumberFormat$$Type)?, "score"?: integer, "display"?: ($Component$$Type)?, "objectiveName"?: StringJS, "owner"?: StringJS}) | ([numberFormat?: ($NumberFormat$$Type)?, score?: integer, display?: ($Component$$Type)?, objectiveName?: StringJS, owner?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClientboundDamageEventPacket$$Type = ({"sourcePosition"?: ($Vec3$$Type)?, "entityId"?: integer, "sourceDirectId"?: integer, "sourceCauseId"?: integer, "sourceType"?: $Holder$$Type<($DamageType)>}) | ([sourcePosition?: ($Vec3$$Type)?, entityId?: integer, sourceDirectId?: integer, sourceCauseId?: integer, sourceType?: $Holder$$Type<($DamageType)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClientboundUpdateAttributesPacket$AttributeSnapshot$$Type = ({"modifiers"?: $Collection$$Type<($AttributeModifier$$Type)>, "attribute"?: $Holder$$Type<($Attribute)>, "base"?: double}) | ([modifiers?: $Collection$$Type<($AttributeModifier$$Type)>, attribute?: $Holder$$Type<($Attribute)>, base?: double]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ServerboundChatCommandSignedPacket$$Type = ({"salt"?: long, "command"?: StringJS, "timeStamp"?: $Instant$$Type, "lastSeenMessages"?: $LastSeenMessages$Update$$Type, "argumentSignatures"?: $ArgumentSignatures$$Type}) | ([salt?: long, command?: StringJS, timeStamp?: $Instant$$Type, lastSeenMessages?: $LastSeenMessages$Update$$Type, argumentSignatures?: $ArgumentSignatures$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ServerboundChatPacket$$Type = ({"salt"?: long, "timeStamp"?: $Instant$$Type, "signature"?: $MessageSignature$$Type, "message"?: StringJS, "lastSeenMessages"?: $LastSeenMessages$Update$$Type}) | ([salt?: long, timeStamp?: $Instant$$Type, signature?: $MessageSignature$$Type, message?: StringJS, lastSeenMessages?: $LastSeenMessages$Update$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
