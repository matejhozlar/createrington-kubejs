 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ModMismatchEvent$MismatchResolutionResult$$Type = ({"versionDifference"?: $ModMismatchEvent$MismatchedVersionInfo$$Type, "modid"?: StringJS, "resolver"?: $ModContainer$$Type}) | ([versionDifference?: $ModMismatchEvent$MismatchedVersionInfo$$Type, modid?: StringJS, resolver?: $ModContainer$$Type]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
