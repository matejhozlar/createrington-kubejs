 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Animation$Keyframes$$Type = ({"customInstructions"?: ($CustomInstructionKeyframeData$$Type)[], "particles"?: ($ParticleKeyframeData$$Type)[], "sounds"?: ($SoundKeyframeData$$Type)[]}) | ([customInstructions?: ($CustomInstructionKeyframeData$$Type)[], particles?: ($ParticleKeyframeData$$Type)[], sounds?: ($SoundKeyframeData$$Type)[]]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Animation$$Type = ({"boneAnimations"?: ($BoneAnimation$$Type)[], "loopType"?: $Animation$LoopType$$Type, "keyFrames"?: $Animation$Keyframes$$Type, "length"?: double, "name"?: StringJS}) | ([boneAnimations?: ($BoneAnimation$$Type)[], loopType?: $Animation$LoopType$$Type, keyFrames?: $Animation$Keyframes$$Type, length?: double, name?: StringJS]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Keyframe$$Type<T> = ({"endValue"?: T, "easingType"?: $EasingType$$Type, "easingArgs"?: $List$$Type<(T)>, "startValue"?: T, "length"?: double}) | ([endValue?: T, easingType?: $EasingType$$Type, easingArgs?: $List$$Type<(T)>, startValue?: T, length?: double]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
