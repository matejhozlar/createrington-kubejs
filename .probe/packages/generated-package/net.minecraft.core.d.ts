 ...
 * types for convenience unless there's a naming conflict.
 */
export type $Holder$Reference$Type$$Type = (("stand_alone") | ("intrusive"));
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $Holder$Reference$Type$$Original = $Holder$Reference$Type;}
...
constructor(key: $ResourceKey$$Type<($Registry<(T)>)>, lifecycle: $Lifecycle$$Type, bootstrap: $RegistrySetBuilder$RegistryBootstrap$$Type<(T)>)
...
public static "wrapContextLookup"<T>(arg0: $HolderLookup$RegistryLookup$$Type<(T)>): $HolderGetter<(T)>
...
readonly "tToId": $Reference2IntMap<(T)>
 "nextId": integer
readonly "idToT": $List<(T)>
...
constructor(arg0: $HolderOwner$$Type<(T)>, arg1: $TagKey$$Type<(T)>)
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $RegistryAccess$RegistryEntry$$Type<T> = ($RegistryAccess$RegistryEntry<(T)>);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
static readonly "EMPTY": $HolderSet$Direct<(never)>

constructor(arg0: $List$$Type<($Holder$$Type<(T)>)>)
