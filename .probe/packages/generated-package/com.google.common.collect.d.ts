...
public "entries"(): $ImmutableCollection
/**
 * 
 * @deprecated
 */
...
import {$Collector} from "java.util.stream.Collector"
import {$ObjIntConsumer$$Type} from "java.util.function.ObjIntConsumer"
import {$Multiset$$Interface} from "com.google.common.collect.Multiset"
...
export class $ImmutableMultiset<E> extends $ImmutableMultisetGwtSerializationDependencies<(E)> implements $Multiset$$Interface<(E)> {
/**
 * 
 * @deprecated
 */
...
public static "toImmutableMultiset"<E>(): $Collector<(E), (never), ($ImmutableMultiset<(E)>)>
public static "toImmutableMultiset"<T, E>(elementFunction: $Function$$Type<(T), (E)>, countFunction: $ToIntFunction$$Type<(T)>): $Collector<(T), (never), ($ImmutableMultiset<(E)>)>
...
public "removeAll"(c: $Collection$$Type<(never)>): boolean
public "retainAll"(c: $Collection$$Type<(never)>): boolean
public "containsAll"(elements: $Collection$$Type<(never)>): boolean
public "clear"(): void
public "isEmpty"(): boolean
public "toArray"<T>(arg0: (T)[]): (T)[]
public "toArray"(): (any)[]
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ImmutableMultiset$$Original<E> = $ImmutableMultiset<(E)>;}
