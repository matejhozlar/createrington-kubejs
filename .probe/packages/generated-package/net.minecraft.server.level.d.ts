...
import {$ServerLevelAccessor$$Interface} from "net.caffeinemc.mods.lithium.mixin.minimal_nonvanilla.spawning.ServerLevelAccessor"
...
import {$ServerLevelAccessor$$Interface as $ServerLevelAccessor$2$$Interface} from "net.caffeinemc.mods.lithium.mixin.util.accessors.ServerLevelAccessor"
...
import {$LightningAccessor$$Interface} from "org.patryk3211.powergrid.mixin.LightningAccessor"
...
export class $ServerLevel extends $Level implements $WorldGenLevel$$Interface, $IServerLevel$$Interface, $ISafeBlockGetter$$Interface, $ServerWorldExtended$$Interface, $ServerLevelAccessor$$Interface, $ServerLevelAccessor$2$$Interface, $ServerLevelAccessor$0$$Interface, $IWorldMapServerLevel$$Interface, $AttachmentTargetImpl$$Interface, $ServerWorldCache$$Interface, $LinkManager$Access$$Interface, $ServerLevelKJS$$Interface, $LightningAccessor$$Interface, $ServerLevelAccessor$1$$Interface, $NorthstarLevel$$Interface {
...
public "handler$hii000$northstar$venusTickChunk"(chunk: $LevelChunk$$Type, randomTickSpeed: integer, info: $CallbackInfo$$Type): void
public "redirect$fdf000$observable$onTickLiquid"(state: $FluidState$$Type, level: $Level$$Type, pos: $BlockPos$$Type): void
public "redirect$fdf000$observable$onTickBlock"(state: $BlockState$$Type, level: $ServerLevel$$Type, pos: $BlockPos$$Type, random: $RandomSource$$Type): void
public "redirect$fdf000$observable$onTickPassenger"(entity: $Entity$$Type): void
public "refurbishedFurniture$GetLinkManager"(): $LinkManager
public "isPositionEntityTicking"(arg0: $BlockPos$$Type): boolean
public "handler$ddm000$immersive_melodies$immersiveMelodies$injectTickPassenger"(arg0: $Entity$$Type, arg1: $Entity$$Type, arg2: $CallbackInfo$$Type): void
public "handler$ddm000$immersive_melodies$immersiveMelodies$injectTickEntity"(arg0: $Entity$$Type, arg1: $CallbackInfo$$Type): void
...
public "redirect$fdf000$observable$onTickNonPassenger"(entity: $Entity$$Type): void
...
public "invokeGetLightningPos"(arg0: $BlockPos$$Type): $BlockPos
...
import {$ChunkMapAccessor$$Interface as $ChunkMapAccessor$0$$Interface} from "org.patryk3211.powergrid.mixin.ChunkMapAccessor"
import {$ChunkAccess, $ChunkAccess$$Type} from "net.minecraft.world.level.chunk.ChunkAccess"
...
import {$Supplier$$Type} from "java.util.function.Supplier"
import {$ThreadedAnvilChunkStorageAccessor$$Interface} from "org.patryk3211.powergrid.mixin.forge.ThreadedAnvilChunkStorageAccessor"
...
import {$ServerChunkLoadingManagerAccessor$$Interface as $ServerChunkLoadingManagerAccessor$0$$Interface} from "net.fabricmc.fabric.mixin.networking.accessor.ServerChunkLoadingManagerAccessor"
...
export class $ChunkMap extends $ChunkStorage implements $ChunkHolder$PlayerProvider$$Interface, $GeneratingChunkMap$$Interface, $ServerChunkLoadingManagerAccessor$$Interface, $ChunkMapAccessor$$Interface, $ServerChunkLoadingManagerAccessor$0$$Interface, $ChunkMapAccessor$0$$Interface, $ThreadedAnvilChunkStorageAccessor$$Interface {
...
public "getEntityTrackers"(): $Int2ObjectMap
public "redirect$cln000$smoothchunk$smoothChunksaveChunks"(arg0: $ObjectCollection$$Type): $ObjectIterator
...
get "entityTrackers"(): $Int2ObjectMap
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
public "blockChanged"(arg0: $BlockPos$$Type): void
public "hasChunk"(arg0: integer, arg1: integer): boolean
public "handler$cma000$smoothchunk$onSaveALlChunks"(arg0: boolean, arg1: $CallbackInfo$$Type): void
public "addEntity"(arg0: $Entity$$Type): void
...
public "handler$ddl000$immersive_melodies$immersiveMelodies$injectServerChunkManagerInit"(arg0: $ServerLevel$$Type, arg1: $LevelStorageSource$LevelStorageAccess$$Type, arg2: $DataFixer$$Type, arg3: $StructureTemplateManager$$Type, arg4: $Executor$$Type, arg5: $ChunkGenerator$$Type, arg6: integer, arg7: integer, arg8: boolean, arg9: $ChunkProgressListener$$Type, arg10: $ChunkStatusUpdateListener$$Type, arg11: $Supplier$$Type, arg12: $CallbackInfo$$Type): void
...
import {$BlockPos, $BlockPos$$Type} from "net.minecraft.core.BlockPos"
import {$ServerPlayerData as $ServerPlayerData$0, $ServerPlayerData$$Type as $ServerPlayerData$0$$Type} from "xaero.map.server.player.ServerPlayerData"
import {$IServerPlayer$$Interface} from "xaero.lib.common.player.IServerPlayer"
...
import {$Optional} from "java.util.Optional"
import {$ServerPlayerData as $ServerPlayerData$1, $ServerPlayerData$$Type as $ServerPlayerData$1$$Type} from "xaero.lib.common.player.ServerPlayerData"
...
import {$IServerPlayer$$Interface as $IServerPlayer$0$$Interface} from "xaero.map.server.player.IServerPlayer"
...
export class $ServerPlayer extends $Player implements $IOpenPACServerPlayer$$Interface, $IServerPlayer$1$$Interface, $IServerPlayer$0$$Interface, $ServerPlayerAccessor$$Interface, $ServerPlayerKJS$$Interface, $IServerPlayer$$Interface, $IMixinServerPlayer$$Interface, $NorthstarPlayer$$Interface, $NorthstarServerPlayer$$Interface {
 "lerpYRot": double
...
public "setXaeroMinimapPlayerData"(arg0: $ServerPlayerData$$Type): void
...
public "getXaeroWorldMapPlayerData"(): $ServerPlayerData$0
...
public "getXaeroMinimapPlayerData"(): $ServerPlayerData
public "setChunkTrackingView"(arg0: $ChunkTrackingView$$Type): void
public "setXaeroWorldMapPlayerData"(arg0: $ServerPlayerData$0$$Type): void
...
public "xaerolib_getData"(): $ServerPlayerData$1
public "xaerolib_setData"(arg0: $ServerPlayerData$1$$Type): void
...
public "handler$foi000$distanthorizons$setServerLevel"(level: $ServerLevel$$Type, ci: $CallbackInfo$$Type): void
public "handler$foi000$distanthorizons$changeDimension"(dimensionTransition: $DimensionTransition$$Type, cir: $CallbackInfoReturnable$$Type): void
public "handler$zpp000$quickrightclick$setRespawnPosition"(arg0: $ResourceKey$$Type, arg1: $BlockPos$$Type, arg2: float, arg3: boolean, arg4: boolean, arg5: $CallbackInfo$$Type): void
...
get "xaeroWorldMapPlayerData"(): $ServerPlayerData$0
...
set "xaeroWorldMapPlayerData"(value: $ServerPlayerData$0$$Type)
...
import {$EntityTrackerAccessor$$Interface as $EntityTrackerAccessor$1$$Interface} from "org.patryk3211.powergrid.mixin.forge.EntityTrackerAccessor"
...
import {$EntityTrackerAccessor$$Interface as $EntityTrackerAccessor$0$$Interface} from "io.wispforest.accessories.mixin.EntityTrackerAccessor"
import {$Set} from "java.util.Set"
import {$ChunkMapAccessor$TrackedEntityAccessor$$Interface} from "org.patryk3211.powergrid.mixin.ChunkMapAccessor$TrackedEntityAccessor"
import {$Packet$$Type} from "net.minecraft.network.protocol.Packet"
import {$ServerPlayer$$Type} from "net.minecraft.server.level.ServerPlayer"
import {$Entity, $Entity$$Type} from "net.minecraft.world.entity.Entity"
import {$ServerEntity} from "net.minecraft.server.level.ServerEntity"
import {$ChunkMapAccessor$TrackedEntityAccessor$$Interface as $ChunkMapAccessor$TrackedEntityAccessor$0$$Interface} from "com.railwayteam.railways.neoforge.mixin.ChunkMapAccessor$TrackedEntityAccessor"

export class $ChunkMap$TrackedEntity implements $EntityTrackerAccessor$0$$Interface, $ChunkMapAccessor$TrackedEntityAccessor$0$$Interface, $EntityTrackerAccessor$$Interface, $ChunkMapAccessor$TrackedEntityAccessor$$Interface, $EntityTrackerAccessor$1$$Interface {
...
public "localvar$dln000$railways$securitycraft$modifyFlag"(arg0: boolean): boolean
