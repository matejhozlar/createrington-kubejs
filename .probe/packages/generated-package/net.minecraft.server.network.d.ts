...
public "localvar$cod000$brewinandchewin$modifyChatMessageForServer"(arg0: $PlayerChatMessage$$Type): $PlayerChatMessage
...
public "handler$faj000$ftbquests$handleClientInformation"(packet: $ServerboundClientInformationPacket$$Type, ci: $CallbackInfo$$Type): void
...
import {$ConnectionProtocol} from "net.minecraft.network.ConnectionProtocol"
import {$ServerCommonNetworkHandlerAccessor$$Interface as $ServerCommonNetworkHandlerAccessor$0$$Interface} from "net.fabricmc.fabric.mixin.networking.accessor.ServerCommonNetworkHandlerAccessor"
import {$Packet$$Type} from "net.minecraft.network.protocol.Packet"
import {$GameProfile} from "com.mojang.authlib.GameProfile"
...
export class $ServerCommonPacketListenerImpl implements $ServerCommonPacketListener$$Interface, $IServerCommonPacketListenerImpl$$Interface, $ServerCommonNetworkHandlerAccessor$0$$Interface, $ServerCommonNetworkHandlerAccessor$$Interface {
static readonly "LATENCY_CHECK_INTERVAL": integer
readonly "server": $MinecraftServer
static readonly "DISCONNECT_UNEXPECTED_QUERY": $Component
readonly "connection": $Connection
...
public "owo$server"(): $MinecraftServer
...
public "getServer"(): $MinecraftServer
public "owo$getConnection"(): $Connection
public "wrapOperation$fch000$fabric_networking_api_v1$onCustomPayloadRegisterPacket"(arg0: $Connection$$Type, arg1: $Set$$Type, arg2: $Operation$$Type): void
public "wrapOperation$fch000$fabric_networking_api_v1$onCustomPayloadUnregisterPacket"(arg0: $Connection$$Type, arg1: $Set$$Type, arg2: $Operation$$Type): void
public "onDisconnect"(arg0: $DisconnectionDetails$$Type): void
public "playerProfile"(): $GameProfile
