...
declare module "net.caffeinemc.mods.lithium.common.world.chunk.ClassGroupFilterableList" {
import {$Collection, $Collection$$Type} from "java.util.Collection"
import {$EntityClassGroup, $EntityClassGroup$$Type} from "net.caffeinemc.mods.lithium.common.entity.EntityClassGroup"

export interface $ClassGroupFilterableList$$Interface<T> {

(arg0: $EntityClassGroup): $Collection$$Type<(T)>
}

export class $ClassGroupFilterableList<T> implements $ClassGroupFilterableList$$Interface {
 "lithium$getAllOfGroupType"(arg0: $EntityClassGroup$$Type): $Collection<(T)>
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $ClassGroupFilterableList$$Type<T> = ((arg0: $EntityClassGroup) => $Collection$$Type<(T)>);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ClassGroupFilterableList$$Original<T> = $ClassGroupFilterableList<(T)>;}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $LithiumData$Data$$Type = ({"ominousBanner"?: $ItemStack$$Type, "chunkSectionChangeCallbacks"?: $Long2ReferenceOpenHashMap$$Type<($ChunkSectionChangeCallback$$Type)>, "entityMovementTrackers"?: $LithiumInterner$$Type<($SectionedEntityMovementTracker$$Type<(never), (never)>)>, "activeNavigations"?: $ReferenceOpenHashSet$$Type<($PathNavigation$$Type)>, "gameEventDispatchers"?: $GameEventDispatcherStorage$$Type, "blockChangeTrackers"?: $LithiumInterner$$Type<($SectionedBlockChangeTracker$$Type)>}) | ([ominousBanner?: $ItemStack$$Type, chunkSectionChangeCallbacks?: $Long2ReferenceOpenHashMap$$Type<($ChunkSectionChangeCallback$$Type)>, entityMovementTrackers?: $LithiumInterner$$Type<($SectionedEntityMovementTracker$$Type<(never), (never)>)>, activeNavigations?: $ReferenceOpenHashSet$$Type<($PathNavigation$$Type)>, gameEventDispatchers?: $GameEventDispatcherStorage$$Type, blockChangeTrackers?: $LithiumInterner$$Type<($SectionedBlockChangeTracker$$Type)>]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
declare module "net.caffeinemc.mods.lithium.mixin.alloc.entity_iteration.ClassInstanceMultiMapAccessor" {
import {$List, $List$$Type} from "java.util.List"

export interface $ClassInstanceMultiMapAccessor$$Interface<T> {

(): $List$$Type<(T)>
get "allInstances"(): $List<(T)>
}

export class $ClassInstanceMultiMapAccessor<T> implements $ClassInstanceMultiMapAccessor$$Interface {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ClassInstanceMultiMapAccessor$$Type<T> = (() => $List$$Type<(T)>);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $ClassInstanceMultiMapAccessor$$Original<T> = $ClassInstanceMultiMapAccessor<(T)>;}
...
constructor(arg0: $BiPredicate$$Type<($Class<(never)>), ($Supplier<($EntityType<(never)>)>)>)

public "clear"(): void
public "contains"(arg0: $Entity$$Type): boolean
public "contains"(arg0: $Class$$Type<(never)>, arg1: $EntityType$$Type<(never)>): boolean
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 ...
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $EntityClassGroup$$Original = $EntityClassGroup;}
 ...
 * types for convenience unless there's a naming conflict.
 */
export type $WorldSectionBox$$Type = ({"chunkX1"?: integer, "world"?: $Level$$Type, "chunkZ2"?: integer, "chunkZ1"?: integer, "chunkY2"?: integer, "chunkY1"?: integer, "chunkX2"?: integer}) | ([chunkX1?: integer, world?: $Level$$Type, chunkZ2?: integer, chunkZ1?: integer, chunkY2?: integer, chunkY1?: integer, chunkX2?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
...
declare module "net.caffeinemc.mods.lithium.common.entity.TypeFilterableListInternalAccess" {
import {$ArrayList$$Type} from "java.util.ArrayList"
import {$Function$$Type} from "java.util.function.Function"
import {$List, $List$$Type} from "java.util.List"
import {$Class$$Type} from "java.lang.Class"

export interface $TypeFilterableListInternalAccess$$Interface<T> {
}

export class $TypeFilterableListInternalAccess<T> implements $TypeFilterableListInternalAccess$$Interface {
 "lithium$replaceCollectionAndGet"<S>(arg0: $Class$$Type<(S)>, arg1: $Function$$Type<($ArrayList<(S)>), ($List$$Type<(S)>)>): $List<(S)>
 "lithium$replaceCollectionAndGet"<S>(arg0: $Class$$Type<(S)>, arg1: $ArrayList$$Type<(S)>): $List<(S)>
 "lithium$getOrCreateAllOfTypeRaw"<S>(arg0: $Class$$Type<(S)>): $List<(S)>
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $TypeFilterableListInternalAccess$$Type<T> = ($TypeFilterableListInternalAccess<(T)>);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
export type $TypeFilterableListInternalAccess$$Original<T> = $TypeFilterableListInternalAccess<(T)>;}
