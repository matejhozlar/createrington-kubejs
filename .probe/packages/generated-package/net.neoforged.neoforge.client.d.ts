...
import {$PoseStack$Pose$$Type} from "com.mojang.blaze3d.vertex.PoseStack$Pose"
import {$BlockAndTintGetter$$Type} from "net.minecraft.world.level.BlockAndTintGetter"
import {$CreativeQuadLighter$$Interface} from "team.creative.creativecore.client.render.model.CreativeQuadLighter"
import {$VertexConsumer$$Type} from "com.mojang.blaze3d.vertex.VertexConsumer"
import {$BlockPos$$Type} from "net.minecraft.core.BlockPos"
...
export class $ChunkRenderTypeSet implements $Iterable$$Interface<($RenderType)>, $ChunkRenderTypeSetAccessor$$Interface, $ExtendedChunkRenderTypeSet$$Interface {
public "isEmpty"(): boolean
