 ...
 * types for convenience unless there's a naming conflict.
 */
export type $ExtensionInfo$$Type = ({"extended"?: boolean, "netCheck"?: $NetworkedEnum$NetworkCheck$$Type, "vanillaCount"?: integer, "totalCount"?: integer}) | ([extended?: boolean, netCheck?: $NetworkedEnum$NetworkCheck$$Type, vanillaCount?: integer, totalCount?: integer]);
/**
 * Original type to represent the class type itself. Use in JSDoc only.
 */
