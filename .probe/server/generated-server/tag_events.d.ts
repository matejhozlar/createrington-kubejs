...
function tags(extra: "createdieselgenerators:fuel_type", handler: (event: $TagEventProbe<(Special.CreatedieselgeneratorsFuelTypeTag), (Special.CreatedieselgeneratorsFuelType)>) => void): void
