...
declare module "@package/com/mojang/serialization" {
    ...
    export interface $MapCodec<A> extends RegistryMarked<RegistryTypes.CreatePotatoProjectileRenderModeTag, RegistryTypes.CreatePotatoProjectileRenderMode> {}
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.WorldgenMaterialRule | RegistryTypes.SpawnConditionType | RegistryTypes.BlockType | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.EnchantmentProviderType | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.WorldgenBiomeSource | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.EntitySubPredicateType | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.CreatePotatoProjectileRenderMode;
