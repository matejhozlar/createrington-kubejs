...
import { $FabricTagFile } from "@package/net/fabricmc/fabric/api/tag/v1";
...
declare module "@package/net/minecraft/tags" {
    ...
    export class $TagFile extends $Record implements $FabricTagFile {
     ...
     */
    export type $TagFile_ = { replace?: boolean, entries?: $List_<$TagEntry>, remove?: $List_<$TagEntry>,  } | [replace?: boolean, entries?: $List_<$TagEntry>, remove?: $List_<$TagEntry>, ];
    ...
    export class $TagLoader$SortingEntry extends $Record implements $DependencySorter$Entry<$ResourceLocation> {
        ...
        visitOptionalDependencies(visitor: $Consumer_<$ResourceLocation>): void;
        visitRequiredDependencies(visitor: $Consumer_<$ResourceLocation>): void;
        constructor(entries: $List_<$TagLoader$EntryWithSource_>);
    }
    /**
