...
import { $QuadrupedModelAccessor } from "@package/com/furiusmax/bjornlib/neo/mixin/client";
...
declare module "@package/net/minecraft/client/model" {
    ...
    export class $RabbitModel<T extends $Rabbit> extends $EntityModel<T> {
        ...
        handler$dfo004$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $HierarchicalModel<E extends $Entity> extends $EntityModel<E> {
        ...
        handler$dfp005$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $AgeableListModel<E extends $Entity> extends $EntityModel<E> implements $AgeableListModelAccessor, $AgeableListModelAccessor$1 {
        ...
        handler$dfe000$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
    ...
    export class $HumanoidModel<T extends $LivingEntity> extends $AgeableListModel<T> implements $ArmedModel, $HeadedModel, $IMutableModel {
        ...
        handler$jhn000$moonlight$poseRightArm(arg0: $LivingEntity, arg1: $CallbackInfo): void;
        handler$jhn000$moonlight$poseLeftArm(arg0: $LivingEntity, arg1: $CallbackInfo): void;
        copyPropertiesTo(model: $HumanoidModel<T>): void;
        prepareMobModel(entity: T, limbSwing: number, limbSwingAmount: number, partialTick: number): void;
        handler$jhn000$moonlight$setupAnim(arg0: $LivingEntity, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
    ...
    export class $PlayerModel<T extends $LivingEntity> extends $HumanoidModel<T> implements $PlayerModelAccessor$1, $PlayerModelAccessor, $PlayerEntityModelAccessor, $IPlayerModel {
        hasThinArms(): boolean;
        renderEars(poseStack: $PoseStack, buffer: $VertexConsumer, packedLight: number, packedOverlay: number): void;
        setIgnored(visible: boolean): void;
        ...
        handler$kao001$watut$setupAnim(arg0: $LivingEntity, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $CallbackInfo): void;
    ...
    export class $ListModel<E extends $Entity> extends $EntityModel<E> {
        ...
        handler$dfj001$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        attackTime: number;
        young: boolean;
        riding: boolean;
        constructor();
    ...
    export class $LlamaModel<T extends $AbstractChestedHorse> extends $EntityModel<T> {
         ...
         */
        setupAnim(entity: T, limbSwing: number, limbSwingAmount: number, ageInTicks: number, netHeadYaw: number, headPitch: number): void;
        handler$dfm003$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        attackTime: number;
        young: boolean;
        riding: boolean;
        constructor(root: $ModelPart);
