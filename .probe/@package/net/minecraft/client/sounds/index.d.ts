...
import { $ISoundLists } from "@package/com/leobeliik/extremesoundmuffler/interfaces";
...
declare module "@package/net/minecraft/client/sounds" {
     ...
     */
    export class $SoundManager extends $SimplePreparableReloadListener<$SoundManager$Preparations> implements $SoundManagerAccessor, $SoundExtension, $IdentifiableResourceReloadListener {
        /**
     ...
     */
    export class $SoundEngine implements $SoundEngineAccessor, $ISoundLists, $SoundExtension {
         ...
         */
        callCalculateVolume(sound: $SoundInstance): number;
