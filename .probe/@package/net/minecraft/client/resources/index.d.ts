...
import { $MinecraftProfileTextures_, $MinecraftSessionService, $MinecraftProfileTexture$Type_, $MinecraftProfileTexture } from "@package/com/mojang/authlib/minecraft";
