...
declare module "@package/net/minecraft/client/renderer/blockentity" {
    ...
    export class $HangingSignRenderer extends $SignRenderer {
        handler$gfg000$amendments$renderEnhancedSign(arg0: $SignBlockEntity, arg1: number, arg2: $PoseStack, arg3: $MultiBufferSource_, arg4: number, arg5: number, arg6: $CallbackInfo): void;
        static createHangingSignLayer(): $LayerDefinition;
        handler$gfg001$amendments$initEnhancedSign(arg0: $BlockEntityRendererProvider$Context, arg1: $CallbackInfo): void;
        constructor(context: $BlockEntityRendererProvider$Context);
    }
    ...
    export class $SkullBlockRenderer implements $BlockEntityRenderer<$SkullBlockEntity> {
        ...
        handler$jce000$skinlayers3d$render(skullBlockEntity: $SkullBlockEntity, f: number, poseStack: $PoseStack, multiBufferSource: $MultiBufferSource_, i: number, j: number, info: $CallbackInfo): void;
    ...
    export class $BellRenderer implements $BlockEntityRenderer<$BellBlockEntity> {
        ...
        handler$gfe000$amendments$render(arg0: $BellBlockEntity, arg1: number, arg2: $PoseStack, arg3: $MultiBufferSource_, arg4: number, arg5: number, arg6: $CallbackInfo): void;
    ...
    export class $BlockEntityRenderDispatcher implements $ResourceManagerReloadListener, $BlockEntityRenderDispatcherExtension {
        ...
        handler$dhc000$entityculling$render(blockEntity: $BlockEntity, f: number, poseStack: $PoseStack, multiBufferSource: $MultiBufferSource_, info: $CallbackInfo): void;
        modify$hmb000$sable$moveCameraPosForCheck(arg0: $Vec3_): $Vec3;
    ...
    export class $TheEndPortalRenderer<T extends $TheEndPortalBlockEntity> implements $BlockEntityRenderer<T> {
        ...
        handler$zpd000$iris$onRender(arg0: $TheEndPortalBlockEntity, arg1: number, arg2: $PoseStack, arg3: $MultiBufferSource_, arg4: number, arg5: number, arg6: $CallbackInfo): void;
        getOffsetUp(): number;
