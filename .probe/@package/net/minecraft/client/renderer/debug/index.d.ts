...
declare module "@package/net/minecraft/client/renderer/debug" {
    ...
    export class $DebugRenderer {
        ...
        handler$jhe000$moonlight$supp$renderVanillaDebug(arg0: $PoseStack, arg1: $MultiBufferSource$BufferSource, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
     ...
     */
    export type $GameEventListenerRenderer$TrackedGameEvent_ = { gameEvent?: $ResourceKey_<$GameEvent>, timeStamp?: number, position?: $Vec3_,  } | [gameEvent?: $ResourceKey_<$GameEvent>, timeStamp?: number, position?: $Vec3_, ];
    export class $ChunkBorderRenderer implements $DebugRenderer$SimpleDebugRenderer {
        render(poseStack: $PoseStack, bufferSource: $MultiBufferSource_, camX: number, arg3: number, camY: number): void;
        handler$hla000$sable$render(arg0: $PoseStack, arg1: $MultiBufferSource_, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        clear(): void;
        constructor(minecraft: $Minecraft);
    }
