...
import { $LivingEntityRendererAccessor as $LivingEntityRendererAccessor$1 } from "@package/com/furiusmax/bjornlib/neo/mixin/client";
...
declare module "@package/net/minecraft/client/renderer/entity" {
    export class $EnderDragonRenderer$DragonModel extends $EntityModel<$EnderDragon> {
        handler$dfk002$xaerominimap$onRender(arg0: $PoseStack, arg1: $VertexConsumer, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
        /**
    ...
    export class $EntityRenderer<T extends $Entity> implements $EntityRendererAccessor, $EntityRendererExtension, $EntityRendererInter<any> {
        ...
        renderLeash<E extends $Entity>(entity: $Object, partialTick: number, poseStack: $PoseStack, bufferSource: $MultiBufferSource_, leashHolder: E): void;
        ...
        modifyReturnValue$hkf000$sable$getPackedLightCoords(arg0: number, arg1: $Entity, arg2: number): number;
        ...
        callGetBlockLightLevel<T extends $Entity>(entity: T, pos: $BlockPos_): number;
        shadowRadius: number;
        static LEASH_RENDER_STEPS: number;
        entityRenderDispatcher: $EntityRenderDispatcher;
        shadowStrength: number;
    ...
    export class $LivingEntityRenderer<T extends $LivingEntity, M extends $EntityModel<T>> extends $EntityRenderer<T> implements $RenderLayerParent<T, M>, $LivingEntityRendererAccessor<any, any>, $AccessorLivingEntityRenderer<any>, $LivingEntityRendererAccessor$1 {
        scale(livingEntity: T, poseStack: $PoseStack, partialTickTime: number): void;
        ...
        callSetupRotations(entity: T, poseStack: $PoseStack, bob: number, yBodyRot: number, partialTick: number, scale: number): void;
        callGetRenderType(livingEntity: $LivingEntity, bodyVisible: boolean, translucent: boolean, glowing: boolean): $RenderType;
        shadowRadius: number;
        static LEASH_RENDER_STEPS: number;
        entityRenderDispatcher: $EntityRenderDispatcher;
        layers: $List<$RenderLayer<T, M>>;
    ...
    export class $MobRenderer<T extends $Mob, M extends $EntityModel<T>> extends $LivingEntityRenderer<T, M> {
        ...
        md66668e$vanillabackport$getShadowRadius$0(entity: $Entity): number;
        shadowRadius: number;
        static LEASH_RENDER_STEPS: number;
        defaultModel: $EntityModel<any>;
        entityRenderDispatcher: $EntityRenderDispatcher;
    ...
    export class $ItemRenderer implements $ResourceManagerReloadListener, $ItemRendererAccessor$1, $ItemRendererAccessor$2, $ItemRendererAccessor, $IdentifiableResourceReloadListener {
        ...
        handler$jcl000$dragonlib$render(itemStack: $ItemStack_, displayContext: $ItemDisplayContext_, leftHand: boolean, poseStack: $PoseStack, bufferSource: $MultiBufferSource_, combinedLight: number, combinedOverlay: number, model: $BakedModel, ci: $CallbackInfo): void;
        ...
        handler$bjk000$ldlib2$injectRenderItem(arg0: $ItemStack_, arg1: $ItemDisplayContext_, arg2: boolean, arg3: $PoseStack, arg4: $MultiBufferSource_, arg5: number, arg6: number, arg7: $BakedModel, arg8: $CallbackInfo): void;
        static hasAnimatedTexture$sodium_$md$66668e$0(stack: $ItemStack_): boolean;
        reload(preparationBarrier: $PreparableReloadListener$PreparationBarrier_, resourceManager: $ResourceManager, preparationsProfiler: $ProfilerFiller, reloadProfiler: $ProfilerFiller, backgroundExecutor: $Executor_, gameExecutor: $Executor_): $CompletableFuture<void>;
        getName(): string;
