...
import { $Function, $Supplier, $DoubleSupplier, $Predicate_, $Predicate, $Function_, $BiFunction_ } from "@package/java/util/function";
...
import { $NoiseSettingsOverride } from "@package/com/agent772/dimconfig/duck";
...
import { $ContextNoiseSampler } from "@package/com/blackgear/vanillabackport/common/api/worldgen";
...
declare module "@package/net/minecraft/world/level/levelgen" {
     ...
     */
    export type $NoiseRouter_ = { barrierNoise?: $DensityFunction_, vegetation?: $DensityFunction_, depth?: $DensityFunction_, ridges?: $DensityFunction_, erosion?: $DensityFunction_, fluidLevelSpreadNoise?: $DensityFunction_, fluidLevelFloodednessNoise?: $DensityFunction_, lavaNoise?: $DensityFunction_, veinToggle?: $DensityFunction_, initialDensityWithoutJaggedness?: $DensityFunction_, continents?: $DensityFunction_, veinGap?: $DensityFunction_, veinRidged?: $DensityFunction_, finalDensity?: $DensityFunction_, temperature?: $DensityFunction_,  } | [barrierNoise?: $DensityFunction_, vegetation?: $DensityFunction_, depth?: $DensityFunction_, ridges?: $DensityFunction_, erosion?: $DensityFunction_, fluidLevelSpreadNoise?: $DensityFunction_, fluidLevelFloodednessNoise?: $DensityFunction_, lavaNoise?: $DensityFunction_, veinToggle?: $DensityFunction_, initialDensityWithoutJaggedness?: $DensityFunction_, continents?: $DensityFunction_, veinGap?: $DensityFunction_, veinRidged?: $DensityFunction_, finalDensity?: $DensityFunction_, temperature?: $DensityFunction_, ];
    ...
    export class $DebugLevelSource extends $ChunkGenerator implements $DebugChunkGeneratorAccessor {
        static setBLOCK_STATES$fabric_registry_sync_v0_$md$66668e$0(arg0: $List_<any>): void;
        static setX_SIDE_LENGTH$fabric_registry_sync_v0_$md$66668e$1(arg0: number): void;
        static setZ_SIDE_LENGTH$fabric_registry_sync_v0_$md$66668e$2(arg0: number): void;
        ...
        static set BLOCK_STATES$fabric_registry_sync_v0_$md$66668e$0(value: $List_<any>);
        static set x_SIDE_LENGTH$fabric_registry_sync_v0_$md$66668e$1(value: number);
        static set z_SIDE_LENGTH$fabric_registry_sync_v0_$md$66668e$2(value: number);
    }
    ...
    export class $NoiseBasedChunkGenerator extends $ChunkGenerator implements $NoiseSettingsOverride {
        ...
        dimconfig$setNoiseSettingsOverride(arg0: $Holder_<any>): void;
        dimconfig$getNoiseSettingsOverride(): $Holder<any>;
        featuresPerStep: $Supplier<$List<$FeatureSorter$StepFeatureData>>;
    ...
    export class $SurfaceRules$Context implements $ExtendedSurfaceContext, $ContextNoiseSampler {
