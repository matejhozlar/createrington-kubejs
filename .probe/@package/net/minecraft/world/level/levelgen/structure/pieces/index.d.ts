...
import { $StructurePiecesBuilderAccessor } from "@package/com/furiusmax/bjornlib/neo/mixin/structures";
...
declare module "@package/net/minecraft/world/level/levelgen/structure/pieces" {
     ...
     */
    export type $PieceGenerator$Context_<C> = { random?: $WorldgenRandom, config?: $FeatureConfiguration, heightAccessor?: $LevelHeightAccessor, chunkGenerator?: $ChunkGenerator, structureTemplateManager?: $StructureTemplateManager, chunkPos?: $ChunkPos, seed?: number,  } | [random?: $WorldgenRandom, config?: $FeatureConfiguration, heightAccessor?: $LevelHeightAccessor, chunkGenerator?: $ChunkGenerator, structureTemplateManager?: $StructureTemplateManager, chunkPos?: $ChunkPos, seed?: number, ];
    export class $StructurePiecesBuilder implements $StructurePieceAccessor, $StructurePiecesBuilderAccessor {
        clear(): void;
        isEmpty(): boolean;
