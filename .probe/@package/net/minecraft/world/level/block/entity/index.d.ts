...
import { $GenericFlagPole } from "@package/petrolpark/mc/library/core/flags";
...
import { $DataComponentType, $DataComponentMap$Builder, $DataComponentType_, $DataComponentMap, $DataComponentMap_, $DataComponentPatch_ } from "@package/net/minecraft/core/component";
...
import { $IShulkerBoxBlockEntityDuck } from "@package/petrolpark/mc/library/core/world/block/entity";
...
declare module "@package/net/minecraft/world/level/block/entity" {
    ...
    export class $HopperBlockEntity extends $RandomizableContainerBlockEntity implements $Hopper, $LithiumInventory, $InventoryChangeListener, $UpdateReceiver, $SectionedEntityMovementListener, $InventoryChangeTracker, $SleepingBlockEntity {
        handler$cgk003$lithium$setInventoryStackListReplacement(arg0: $NonNullList<any>, arg1: $CallbackInfo): void;
    ...
    export class $SkullBlockEntity extends $BlockEntity implements $ETFPlayerEntity, $SkullSettings {
        ...
        getMesh(): $Mesh;
        static profileCacheByName: $LoadingCache<string, $CompletableFuture<($GameProfile) | undefined>>;
        worldPosition: $BlockPos;
    ...
    export class $BlockEntityType<T extends $BlockEntity> implements $BlockEntityTypeAccessor, $ExtendedBlockEntityType<any>, $BlockEntityTypeExtension<any>, $FabricBlockEntityType, $AccessorBlockEntityType, $DynamicLightHandlerHolder<any> {
    ...
    export class $BarrelBlockEntity extends $RandomizableContainerBlockEntity implements $LithiumInventory, $InventoryChangeTracker {
        ...
        handler$cgg000$lithium$setInventoryStackListReplacement(arg0: $NonNullList<any>, arg1: $CallbackInfo): void;
    ...
    export class $ChestBlockEntity extends $RandomizableContainerBlockEntity implements $LidBlockEntity, $InventoryChangeEmitter, $LithiumInventory, $InventoryChangeTracker {
        ...
        handler$cgi001$lithium$setInventoryStackListReplacement(arg0: $NonNullList<any>, arg1: $CallbackInfo): void;
        /**
         * Called when this is first added to the world (by `LevelChunk#addAndRegisterBlockEntity(BlockEntity)`)
         * or right before the first tick when the chunk is generated or loaded from disk.
         * Override instead of adding `if (firstTick)` stuff in update.
    ...
    export class $BlockEntity extends $AttachmentHolder implements $IBlockEntityExtension, $RenderDataBlockEntity, $RenderAttachmentBlockEntity, $SupportCache, $ComparatorTracker, $SetChangedHandlingBlockEntity, $Cullable, $AccessorBlockEntity, $DynamicLightSource, $EMFEntity, $ETFEntity, $BlockEntityAccessor {
        ...
        handler$fle001$collective$setRemoved(arg0: $CallbackInfo): void;
        saveToItem(stack: $ItemStack_, registries: $HolderLookup$Provider): void;
        applyComponentsFromItemStack(stack: $ItemStack_): void;
        handler$fle000$collective$setLevel(arg0: $Level_, arg1: $CallbackInfo): void;
        /**
         * @return whether this BlockEntity's level has been set
         */
    ...
    export class $ShulkerBoxBlockEntity extends $RandomizableContainerBlockEntity implements $WorldlyContainer, $LithiumInventory, $InventoryChangeTracker, $SleepingBlockEntity, $IShulkerBoxBlockEntityDuck {
        static tick(level: $Level_, pos: $BlockPos_, state: $BlockState_, blockEntity: $ShulkerBoxBlockEntity): void;
        isClosed(): boolean;
        handler$cgl004$lithium$setInventoryStackListReplacement(arg0: $NonNullList<any>, arg1: $CallbackInfo): void;
        getColor(): $DyeColor;
        ...
        handler$imn000$petrolpark$createFlags(arg0: $CallbackInfo): void;
        handler$imn000$petrolpark$saveFlags(arg0: $CompoundTag_, arg1: $HolderLookup$Provider, arg2: $CallbackInfo): void;
        handler$bdl000$quickrightclick$stopOpen(arg0: $Player, arg1: $CallbackInfo): void;
        handler$imn000$petrolpark$loadFlags(arg0: $CompoundTag_, arg1: $HolderLookup$Provider, arg2: $CallbackInfo): void;
        getProgress(partialTicks: number): number;
        getBoundingBox(state: $BlockState_): $AABB;
        flagAll(arg0: $Stream<any>): void;
    ...
    export class $BrushableBlockEntity extends $BlockEntity implements $AccessorMixinBrushableBlockEntity {
        ...
        wrapOperation$djc000$lootr$tryLoadLootTable(arg0: $CompoundTag_, arg1: string, arg2: number, arg3: $Operation_<any>): boolean;
    ...
    export class $BaseContainerBlockEntity extends $BlockEntity implements $Container, $MenuProvider, $Nameable, $InventoryChangeEmitter, $AccessorMixinBaseContainerBlockEntity, $SpecialLogicInventory {
        getName(): $Component;
        isEmpty(): boolean;
        getDisplayName(): $Component;
        /**
        ...
        handler$cgh000$lithium$readNbtStackListReplacement(arg0: $CompoundTag_, arg1: $HolderLookup$Provider, arg2: $CallbackInfo): void;
        lithium$stopForwardingMajorInventoryChanges(arg0: $InventoryChangeListener): void;
        wrapOperation$gbh000$fabric_transfer_api_v1$fabric_redirectMarkDirty(arg0: $BaseContainerBlockEntity, arg1: $Operation_<any>): void;
    ...
    export class $BrewingStandBlockEntity extends $BaseContainerBlockEntity implements $WorldlyContainer, $LithiumInventory, $InventoryChangeTracker, $SleepingBlockEntity, $SetChangedHandlingBlockEntity {
        ...
        lithium$setTickWrapper(arg0: $WrappedBlockEntityTickInvokerAccessor): void;
        lithium$getSleepingTicker(): $TickingBlockEntity;
        handler$gdp000$amendments$refreshModel(arg0: $CompoundTag_, arg1: $HolderLookup$Provider, arg2: $CallbackInfo): void;
        generateLootLithium(): void;
        listenForMajorInventoryChanges(arg0: $InventoryChangeListener): void;
        stopListenForMajorInventoryChanges(arg0: $InventoryChangeListener): void;
        listenForContentChangesOnce(arg0: $LithiumStackList, arg1: $InventoryChangeListener): void;
    ...
    export class $AbstractFurnaceBlockEntity extends $BaseContainerBlockEntity implements $WorldlyContainer, $RecipeCraftingHolder, $StackedContentsCompatible, $LithiumInventory, $InventoryChangeTracker, $SleepingBlockEntity, $SetChangedHandlingBlockEntity, $AccessorAbstractFurnaceBlockEntity, $SpecialLogicInventory, $Clearable, $AbstractFurnaceBlockEntityAccess {
        ...
        handler$gbd000$fabric_transfer_api_v1$setStackSuppressUpdate(arg0: number, arg1: $ItemStack_, arg2: $CallbackInfo): void;
    ...
    export class $JukeboxBlockEntity extends $BlockEntity implements $Clearable, $ContainerSingleItem$BlockContainerSingleItem, $SpecialLogicInventory, $IBetterJukebox {
        ...
        popOutTheItem(): void;
        handler$geg000$amendments$notifySongChanged(arg0: $CallbackInfo): void;
        fabric_onFinalCommit(arg0: number, arg1: $ItemStack_, arg2: $ItemStack_): void;
        /**
         * Returns `true` if automation is allowed to insert the given stack (ignoring stack size) into the given slot. For guis use Slot.isItemValid
         */
    ...
    export class $DispenserBlockEntity extends $RandomizableContainerBlockEntity implements $LithiumInventory, $InventoryChangeTracker, $DispenserBlockEntityAccessor {
        ...
        handler$cgj002$lithium$setInventoryStackListReplacement(arg0: $NonNullList<any>, arg1: $CallbackInfo): void;
    ...
    export class $RandomizableContainerBlockEntity extends $BaseContainerBlockEntity implements $RandomizableContainer {
        ...
        wrapOperation$dje000$lootr$setLootTable(arg0: $RandomizableContainer, arg1: $ResourceKey_<any>, arg2: $Operation_<any>): void;
        handler$dje000$lootr$unpackLootTable(arg0: $Player, arg1: $CallbackInfo): void;
        wrapOperation$dje000$lootr$tryLoadLootTable(arg0: $RandomizableContainer, arg1: number, arg2: $Operation_<any>): void;
        setLootTable(lootTable: $ResourceKey_<$LootTable>, seed: number): void;
    ...
    export class $LecternBlockEntity extends $BlockEntity implements $Clearable, $MenuProvider, $Container {
        ...
        handler$gej000$amendments$createEditMenu(arg0: number, arg1: $Inventory, arg2: $Player, arg3: $CallbackInfoReturnable<any>): void;
        setPage(page: number): void;
        /**
         * @return whether the ItemStack in this lectern is a book or written book
         */
        hasBook(): boolean;
        handler$gej000$amendments$setPage(arg0: number, arg1: $CallbackInfo): void;
        /**
