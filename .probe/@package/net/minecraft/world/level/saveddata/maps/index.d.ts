...
declare module "@package/net/minecraft/world/level/saveddata/maps" {
    ...
    export class $MapItemSavedData extends $SavedData implements $StationMapData, $ExpandedMapData {
        ...
        handler$jgf000$moonlight$scaled(arg0: $CallbackInfoReturnable<any>): void;
        handler$jgf000$moonlight$save(arg0: $CompoundTag_, arg1: $HolderLookup$Provider, arg2: $CallbackInfoReturnable<any>): void;
        /**
         * Marks this `SavedData` dirty, to be saved to disk when the level next saves.
         */
        ml$setCustomDecorationsDirty(): void;
        handler$jgf000$moonlight$locked(arg0: $CallbackInfoReturnable<any>): void;
        ...
        modifyReturnValue$jgf000$moonlight$ml$isExplorationMap(arg0: boolean): boolean;
        handler$gjp000$create$onCheckBanners(arg0: $BlockGetter, arg1: number, arg2: number, arg3: $CallbackInfo): void;
        handler$jgf000$moonlight$initCustomData(arg0: number, arg1: number, arg2: number, arg3: boolean, arg4: boolean, arg5: boolean, arg6: $ResourceKey_<any>, arg7: $CallbackInfo): void;
        handler$jgf000$moonlight$tickCarriedBy(arg0: $Player, arg1: $ItemStack_, arg2: $CallbackInfo): void;
        handler$jgf000$moonlight$checkCustomDeco(arg0: $BlockGetter, arg1: number, arg2: number, arg3: $CallbackInfo): void;
    ...
    export class $MapItemSavedData$HoldingPlayer implements $IHoldingPlayerExtension {
        ...
        modifyReturnValue$jfa000$moonlight$addExtraPacketData(arg0: $Packet<any>, arg1: $MapId_): $Packet<any>;
        handler$jfa000$moonlight$lockData(arg0: number, arg1: number, arg2: $CallbackInfo): void;
        handler$jfa000$moonlight$checkLocked(arg0: $MapId_, arg1: $CallbackInfoReturnable<any>): void;
        handler$jfa000$moonlight$sanityCheck(arg0: number, arg1: number, arg2: $CallbackInfo): void;
        handler$jfa000$moonlight$initializeDirty(arg0: $MapItemSavedData, arg1: $Player, arg2: $CallbackInfo): void;
