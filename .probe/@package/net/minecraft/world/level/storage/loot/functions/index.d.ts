...
declare module "@package/net/minecraft/world/level/storage/loot/functions" {
    ...
    export class $EnchantedCountIncreaseFunction extends $LootItemConditionalFunction {
        handler$dka000$puzzleslib$run(stack: $ItemStack_, context: $LootContext, callback: $CallbackInfoReturnable<any>): void;
        localvar$dka000$puzzleslib$run(enchantmentLevel: number, itemStack: $ItemStack_, lootContext: $LootContext): number;
    ...
    export class $SetComponentsFunction extends $LootItemConditionalFunction implements $SetComponentsLootFunctionAccessor, $SetComponentsFunctionAccessor {
        ...
        static create$lootjs_$md$66668e$0(arg0: $List_<any>, arg1: $DataComponentPatch_): $SetComponentsFunction;
