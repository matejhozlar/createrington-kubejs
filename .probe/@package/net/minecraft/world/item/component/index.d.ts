...
import { $IExpandedBundleContentsMutable } from "@package/petrolpark/mc/library/core/world/item/bundle";
...
declare module "@package/net/minecraft/world/item/component" {
    ...
    export class $BundleContents$Mutable implements $IBundle$Mutable, $IExpandedBundleContentsMutable {
        ...
        modifyExpressionValue$ile000$petrolpark$pquality$itemsWeighLessInQualityBundles(arg0: $Fraction): $Fraction;
        size: $Fraction;
    ...
    export class $BundleContents implements $TooltipComponent, $BundleContentsAccessor, $IBundle, $BundleContentsComponentAccessor {
        ...
        static callGetWeight$vanillabackport_$md$66668e$0(stack: $ItemStack_): $Fraction;
        getNumberOfItemsToShow(): number;
        weight(): $Fraction;
        static getOccupancy$fabric_transfer_api_v1_$md$66668e$1(stack: $ItemStack_): $Fraction;
