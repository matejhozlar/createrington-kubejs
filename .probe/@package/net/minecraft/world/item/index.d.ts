...
import { $IItemStackDuck } from "@package/petrolpark/mc/library/core/world/item";
...
import { $IItemPropertiesExtensions, $TooltipFlagExtension, $IItemExtension, $IDispensibleContainerItemExtension, $IItemStackExtension } from "@package/net/neoforged/neoforge/common/extensions";
...
import { $TooltipFlagExtension as $TooltipFlagExtension$1 } from "@package/dev/simulated_team/simulated/mixin_interface/tooltip_flag";
...
import { $ItemFrame, $HangingEntity, $PaintingVariant_, $PaintingVariant } from "@package/net/minecraft/world/entity/decoration";
...
import { $ItemAttributeModifiers, $Fireworks_, $Tool_, $ItemAttributeModifiers_, $TooltipProvider, $Tool, $FireworkExplosion_, $BundleContents$Mutable, $ItemAttributeModifiers$Entry_ } from "@package/net/minecraft/world/item/component";
...
import { $Supplier_, $Function, $UnaryOperator, $BiConsumer_, $UnaryOperator_, $Supplier, $ToIntFunction_, $IntFunction, $Consumer_, $Predicate_, $Predicate, $Consumer, $Function_, $BiFunction_ } from "@package/java/util/function";
...
declare module "@package/net/minecraft/world/item" {
    ...
    export interface $TooltipFlag extends $TooltipFlagExtension, $FabricTooltipType, $TooltipTypeMixin {
        isAdvanced(): boolean;
        isCreative(): boolean;
    ...
    export class $ShearsItem extends $Item {
        ...
        modifyReturnValue$jgn000$moonlight$m$mineBlock(arg0: boolean, arg1: $BlockState_): boolean;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        static MAX_BAR_WIDTH: number;
        static BASE_ATTACK_SPEED_ID: $ResourceLocation;
    ...
    export class $AxeItem extends $DiggerItem implements $AxeItemAccessor$1, $AxeItemAccessor {
        ...
        static getStrippedBlocks$emi_$md$66668e$0(): $Map<any, any>;
        static getStrippedBlocks$fabric_content_registries_v0_$md$66668e$1(): $Map<any, any>;
        static setStrippedBlocks$fabric_content_registries_v0_$md$66668e$2(arg0: $Map_<any, any>): void;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        tier: $Tier;
        static MAX_BAR_WIDTH: number;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get strippedBlocks$emi_$md$66668e$0(): $Map<any, any>;
        static get strippedBlocks$fabric_content_registries_v0_$md$66668e$1(): $Map<any, any>;
        static set strippedBlocks$fabric_content_registries_v0_$md$66668e$2(value: $Map_<any, any>);
    }
    ...
    export class $HoeItem extends $DiggerItem implements $HoeItemAccessor, $HoeItemAccessor$1 {
        ...
        static getTillingActions$emi_$md$66668e$0(): $Map<any, any>;
        static getTillingActions$fabric_content_registries_v0_$md$66668e$1(): $Map<any, any>;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get tillingActions$emi_$md$66668e$0(): $Map<any, any>;
        static get tillingActions$fabric_content_registries_v0_$md$66668e$1(): $Map<any, any>;
    }
    ...
    export class $CompassItem extends $Item {
        wrapOperation$ecp000$simulated$setLodestoneData(arg0: $ItemStack_, arg1: $DataComponentType_<any>, arg2: $Object, arg3: $Operation_<any>, arg4: $UseOnContext): $Object;
        static getSpawnPosition(level: $Level_): $GlobalPos;
        wrapOperation$ecp000$simulated$setLodestoneData$mixinextras$bridge$8(arg0: $ItemStack_, arg1: $DataComponentType_<any>, arg2: $Object, arg3: $Operation_<any>, arg4: $LocalRef<any>): $Object;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        static MAX_BAR_WIDTH: number;
        static BASE_ATTACK_SPEED_ID: $ResourceLocation;
    ...
    export class $CreativeModeTab implements $CreativeModeTabKJS {
        ...
        handler$dgf000$fabric_item_group_api_v1$getStacks(arg0: $CreativeModeTab$ItemDisplayParameters_, arg1: $CallbackInfo): void;
    ...
    export class $BoneMealItem extends $Item {
        handler$flf000$collective$BoneMealItem_useOn(arg0: $UseOnContext, arg1: $CallbackInfoReturnable<any>): void;
    ...
    export class $ShovelItem extends $DiggerItem implements $ShovelItemAccessor$1, $ShovelItemAccessor {
        ...
        static getPathStates$emi_$md$66668e$0(): $Map<any, any>;
        static getPathStates$fabric_content_registries_v0_$md$66668e$1(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        tier: $Tier;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get pathStates$emi_$md$66668e$0(): $Map<any, any>;
        static get pathStates$fabric_content_registries_v0_$md$66668e$1(): $Map<any, any>;
    }
    ...
    export class $DiggerItem extends $TieredItem implements $DiggerItemKJS {
        handler$gbo000$kubejs$init(ci: $CallbackInfo, blocks: $TagKey_<any>): void;
    ...
    export class $BucketItem extends $Item implements $DispensibleContainerItem, $BucketItemAccessor, $InjectedBucketItemExtension {
        handler$jco000$architectury$fillBucket(level: $Level_, player: $Player, hand: $InteractionHand_, cir: $CallbackInfoReturnable<any>, stack: $ItemStack_, target: $BlockHitResult): void;
    ...
    export class $TooltipFlag$Default extends $Record implements $TooltipFlag, $TooltipFlagExtension$1 {
        isAdvanced(): boolean;
        advanced(): boolean;
        isCreative(): boolean;
        creative(): boolean;
    ...
    export class $CreativeModeTabs implements $AccessorCreativeModeTabs, $CreativeModeTabsAccessor, $CreativeModeTabsAccessor$1 {
        ...
        static generateFireworksAllDurations(output: $CreativeModeTab$Output_, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        static generateInstrumentTypes(output: $CreativeModeTab$Output_, instruments: $HolderLookup<$Instrument_>, item: $Item_, instrument: $TagKey_<$Instrument>, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        static generatePresetPaintings(output: $CreativeModeTab$Output_, registries: $HolderLookup$Provider, paintingVariants: $HolderLookup$RegistryLookup<$PaintingVariant_>, predicate: $Predicate_<$Holder<$PaintingVariant>>, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        static generateOminousVials(output: $CreativeModeTab$Output_, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        ...
        static generatePotionEffectTypes(output: $CreativeModeTab$Output_, potions: $HolderLookup<$Potion_>, item: $Item_, tabVisibility: $CreativeModeTab$TabVisibility_, requiredFeatures: $FeatureFlagSet): void;
        static generateSuspiciousStews(output: $CreativeModeTab$Output_, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        static getDefaultTab(): $CreativeModeTab;
        static generateEnchantmentBookTypesOnlyMaxLevel(output: $CreativeModeTab$Output_, enchantments: $HolderLookup<$Enchantment_>, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        static setCACHED_PARAMETERS$railways_$md$66668e$0(parameters: $CreativeModeTab$ItemDisplayParameters_): void;
        static getCACHED_PARAMETERS$copycats_$md$66668e$4(): $CreativeModeTab$ItemDisplayParameters;
        static generateEnchantmentBookTypesAllLevels(output: $CreativeModeTab$Output_, enchantments: $HolderLookup<$Enchantment_>, tabVisibility: $CreativeModeTab$TabVisibility_): void;
        static callBuildAllTabContents$copycats_$md$66668e$3(parameters: $CreativeModeTab$ItemDisplayParameters_): void;
        static getCACHED_PARAMETERS$create_connected_$md$66668e$2(): $CreativeModeTab$ItemDisplayParameters;
        static callBuildAllTabContents$create_connected_$md$66668e$1(parameters: $CreativeModeTab$ItemDisplayParameters_): void;
        ...
        static set CACHED_PARAMETERS$railways_$md$66668e$0(value: $CreativeModeTab$ItemDisplayParameters_);
        static get CACHED_PARAMETERS$copycats_$md$66668e$4(): $CreativeModeTab$ItemDisplayParameters;
        static get CACHED_PARAMETERS$create_connected_$md$66668e$2(): $CreativeModeTab$ItemDisplayParameters;
    }
     ...
     * @deprecated
     */
    export class $ItemStack implements $DataComponentHolder, $MutableDataComponentHolder, $IItemStackExtension, $ItemStackExtensions$1, $ItemStackAccessor, $ChangeSubscriber<any>, $ChangePublisher<any>, $ItemStackExtensions, $FabricItemStack, $CachedObject$CachedObjectSource, $ItemStackKJS, $IItemStackDuck {
        ...
        wrapOperation$dpi001$geckolib$removeGeckolibIdOnCopy(arg0: $ItemStack_, arg1: number, arg2: $Operation_<any>): $ItemStack;
        ...
        modifyReturnValue$ilp000$petrolpark$startDecay(arg0: $ItemStack_): $ItemStack;
        ...
        handler$bpa000$fabric_entity_events_v1$canElytraFly(arg0: $LivingEntity, arg1: $CallbackInfoReturnable<any>): void;
    ...
    export class $BlockItem extends $Item implements $IExtendedItem {
        ...
        static updateBlockEntityComponents(level: $Level_, poa: $BlockPos_, stack: $ItemStack_): void;
        getBlock(): $Block;
    ...
    export class $Item implements $FeatureElement, $ItemLike, $IItemExtension, $IrisItemLightProvider, $ItemAccessor, $FabricItem, $ItemExtensions, $ItemVariantCache, $ItemInvoker, $IItemExtension$1, $InjectedItemExtension, $ItemFTBL, $IExtendedItem, $ItemKJS {
        ...
        static getPlayerPOVHitResult$sable_$md$66668e$0(level: $Level_, player: $Player, fluidMode: $ClipContext$Fluid_): $BlockHitResult;
        moonlight$getClientAnimationExtension(): $Object;
        handler$jfe000$moonlight$initializeClient(arg0: $Consumer_<any>, arg1: $CallbackInfo): void;
        ...
        handler$eac000$fabric_item_api_v1$getCraftingRemainingItem(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$eac000$fabric_item_api_v1$hasCraftingRemainingItem(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        ...
        handler$eac000$fabric_item_api_v1$getEquipmentSlot(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$epk000$connector$redirectIsPiglinCurrency(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$eah000$fabric_item_api_v1$shouldCauseBlockBreakReset(arg0: $ItemStack_, arg1: $ItemStack_, arg2: $CallbackInfoReturnable<any>): void;
        getMaxStackSize(stack: $ItemStack_): number;
        modifyReturnValue$eah000$fabric_item_api_v1$shouldCauseReequipAnimation(arg0: boolean, arg1: $ItemStack_, arg2: $ItemStack_, arg3: boolean): boolean;
    ...
    export class $PotionItem extends $Item {
        wrapOperation$gem000$amendments$changePotionDescription(arg0: $Optional<any>, arg1: string, arg2: $Operation_<any>, arg3: $ItemStack_): string;
        wrapOperation$gem000$amendments$changePotionDescription$mixinextras$bridge$11(arg0: $Optional<any>, arg1: string, arg2: $Operation_<any>, arg3: $LocalRef<any>): string;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        static MAX_BAR_WIDTH: number;
        static BASE_ATTACK_SPEED_ID: $ResourceLocation;
    ...
    export class $ItemDisplayContext extends $Enum<$ItemDisplayContext> implements $StringRepresentable, $IExtensibleEnum {
        ...
        static PETROLPARK_DRYING_RACK: $ItemDisplayContext;
        ...
        static PETROLPARK_BELT: $ItemDisplayContext;
     ...
     */
    export type $ItemDisplayContext_ = "none" | "thirdperson_lefthand" | "thirdperson_righthand" | "firstperson_lefthand" | "firstperson_righthand" | "head" | "gui" | "ground" | "fixed" | "petrolpark:belt" | "petrolpark:drying_rack" | "sophisticatedbackpacks:worn";
    ...
    export class $BundleItem extends $Item {
        modifyExpressionValue$ilf000$petrolpark$scaleBarWidth(arg0: $Fraction, arg1: $ItemStack_): $Fraction;
        modifyExpressionValue$ilf000$petrolpark$attachQuality(arg0: $BundleContents$Mutable, arg1: $ItemStack_): $BundleContents$Mutable;
        static getFullnessDisplay(stack: $ItemStack_): number;
        wrapOperation$ilf000$petrolpark$increaseDisplayedMaxContents(arg0: string, arg1: $Object[], arg2: $Operation_<any>, arg3: $ItemStack_): $MutableComponent;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        static MAX_BAR_WIDTH: number;
        static BASE_ATTACK_SPEED_ID: $ResourceLocation;
