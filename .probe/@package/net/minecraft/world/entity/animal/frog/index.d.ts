...
import { $Node, $NodeEvaluator, $Path, $PathfindingContext, $AmphibiousNodeEvaluator } from "@package/net/minecraft/world/level/pathfinder";
...
declare module "@package/net/minecraft/world/entity/animal/frog" {
    ...
    export class $Frog extends $Animal implements $VariantHolder<$Holder<$FrogVariant>>, $VariantDataHolder<any> {
        ...
        noActionTime: number;
        zOld: number;
        static SENSOR_TYPES: $ImmutableList<$SensorType<$Sensor<$Frog>>>;
    ...
    export class $Tadpole extends $AbstractFish {
        ...
        noActionTime: number;
        zOld: number;
        static SENSOR_TYPES: $ImmutableList<$SensorType<$Sensor<$Tadpole>>>;
        timeOffs: number;
        static DATA_SHARED_FLAGS_ID: $EntityDataAccessor<number>;
        static LIVING_ENTITY_FLAG_SPIN_ATTACK: number;
        wasTouchingWater: boolean;
