...
declare module "@package/net/minecraft/world/entity/animal/horse" {
    ...
    export class $AbstractHorse extends $Animal implements $ContainerListener, $HasCustomInventoryScreen, $OwnableEntity, $PlayerRideableJumping, $Saddleable {
        ...
        modifyReturnValue$ilc000$petrolpark$dontRearWhileHarnessed(allowPassengers: boolean): boolean;
        handler$ilc000$petrolpark$inheritHorseMillStressCapacity(arg0: $AgeableMob, arg1: $AbstractHorse, arg2: $CallbackInfo): void;
    ...
    export class $Horse extends $AbstractHorse implements $VariantHolder<$Variant> {
        ...
        handler$iln000$petrolpark$randomizeHorseMillCapacityAttribute(arg0: $RandomSource, arg1: $CallbackInfo): void;
