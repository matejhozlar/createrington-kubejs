...
declare module "@package/net/minecraft/world/entity/ai/goal" {
    ...
    export class $CatSitOnBlockGoal extends $MoveToBlockGoal {
        handler$did000$lootr$LootrPlayersUsing(arg0: $LevelReader, arg1: $BlockPos_, arg2: $CallbackInfoReturnable<any>): void;
        redirect$did000$lootr$LootrIsIn(arg0: $BlockState_, arg1: $Block_): boolean;
        speedModifier: number;
        mob: $PathfinderMob;
        tryTicks: number;
        blockPos: $BlockPos;
    ...
    export class $RemoveBlockGoal extends $MoveToBlockGoal implements $LithiumMoveToBlockGoal {
        ...
        redirect$caj000$lithium$redirectFindNearestBlock(arg0: $RemoveBlockGoal): boolean;
