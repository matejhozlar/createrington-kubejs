...
declare module "@package/net/minecraft/world/entity/ai/sensing" {
    ...
    export class $SensorType<U extends $Sensor<never>> implements $SensorTypeAccessor {
        create(): U;
        static createSensorType$platform_$md$66668e$0(arg0: $Supplier_<any>): $SensorType<any>;
    ...
    export class $PiglinSpecificSensor extends $Sensor<$LivingEntity> {
        redirect$cai000$lithium$redirectFindNearestRepellent(level: $ServerLevel, livingEntity: $LivingEntity): $Optional<any>;
        static TARGETING_RANGE: number;
        constructor();
    }
    ...
    export class $SecondaryPoiSensor extends $Sensor<$Villager> {
        ...
        wrapOperation$fgb000$farmersdelight$detectModdedFarmland(arg0: $ImmutableSet<any>, arg1: $Object, arg2: $Operation_<any>, arg3: $Villager): boolean;
        wrapOperation$fgb000$farmersdelight$detectModdedFarmland$mixinextras$bridge$6(arg0: $ImmutableSet<any>, arg1: $Object, arg2: $Operation_<any>, arg3: $LocalRef<any>): boolean;
        static TARGETING_RANGE: number;
        constructor();
    }
}
