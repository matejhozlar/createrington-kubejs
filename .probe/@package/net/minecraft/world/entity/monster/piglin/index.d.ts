...
declare module "@package/net/minecraft/world/entity/monster/piglin" {
    ...
    export class $Piglin extends $AbstractPiglin implements $CrossbowAttackMob, $InventoryCarrier {
         ...
         */
        isDancing(): boolean;
        localvar$zcb000$openpartiesandclaims$onWantsToPickupPre(stack: $ItemStack_): $ItemStack;
        modify$zcb000$openpartiesandclaims$onWantsToPickupPost(arg0: $Piglin): $Piglin;
