...
declare module "@package/net/minecraft/world/entity/raid" {
    ...
    export class $Raid {
        ...
        handler$zbe000$openpartiesandclaims$onFindRandomSpawnPosPost(arg0: $CallbackInfoReturnable<any>): void;
        handler$zbe000$openpartiesandclaims$onFindRandomSpawnPosPre(arg0: $CallbackInfoReturnable<any>): void;
