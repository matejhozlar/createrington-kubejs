...
declare module "@package/net/minecraft/world/entity/player" {
    ...
    export class $Inventory implements $Container, $Nameable {
        ...
        handler$jfo000$moonlight$ml$fireDropEvent(arg0: $CallbackInfo, arg1: $List_<any>, arg2: number): void;
        /**
         * This function stores as many items of an ItemStack as possible in a matching slot and returns the quantity of left over items.
         */
        ...
        handler$jfo000$moonlight$ml$restoreNotDropped(arg0: $CallbackInfo, arg1: $List_<any>, arg2: number): void;
        /**
         * Drop all armor and main inventory items.
         */
        clearContent(): void;
    ...
    export class $Player extends $LivingEntity implements $IPlayerExtension, $IAnimatedPlayer, $PlayerTypewriterExtension, $PlayerLaunchedPlungerExtension, $DynamicLightSource, $ETFPlayerEntity, $PlayerFreezeExtension, $AccessorPlayer, $PlayerSettings, $PlayerKJS {
        /**
        ...
        handler$imf000$petrolpark$addExtendedInventory(arg0: $Level_, arg1: $BlockPos_, arg2: number, arg3: $GameProfile, arg4: $CallbackInfo): void;
        handler$zbb000$openpartiesandclaims$onMayUseItemAt(arg0: $BlockPos_, arg1: $Direction_, arg2: $ItemStack_, arg3: $CallbackInfoReturnable<any>): void;
        /**
         * Only use is to identify if class is an instance of player for experience dropping
         */
        ...
        handler$bop000$fabric_entity_events_v1$injectElytraCheck(arg0: $CallbackInfoReturnable<any>): void;
        wrapMethod$imf000$petrolpark$setExtendedInventoryMainhand(arg0: $EquipmentSlot_, arg1: $ItemStack_, arg2: $Operation_<any>): void;
        getCooldowns(): $ItemCooldowns;
        handler$zfp000$pvp_flagging$canHarmPlayer(arg0: $Player, arg1: $CallbackInfoReturnable<any>): void;
        handler$ekc000$railways$addModDataVersions(arg0: $CompoundTag_, arg1: $CallbackInfo): void;
        ...
        redirect$hfj000$sable$fixRidingBoundingBox(arg0: $AABB_, arg1: $AABB_): $AABB;
         ...
         */
        mayFly(): boolean;
        handler$fmo000$create_hypertube$createHypertube$mayFly(arg0: $CallbackInfoReturnable<any>): void;
