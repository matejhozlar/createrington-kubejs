...
declare module "@package/net/minecraft/commands/arguments/selector/options" {
     ...
     */
    export type $EntitySelectorOptions$Option_ = { modifier?: $EntitySelectorOptions$Modifier_, description?: $Component_, canUse?: $Predicate_<$EntitySelectorParser>,  } | [modifier?: $EntitySelectorOptions$Modifier_, description?: $Component_, canUse?: $Predicate_<$EntitySelectorParser>, ];
}
