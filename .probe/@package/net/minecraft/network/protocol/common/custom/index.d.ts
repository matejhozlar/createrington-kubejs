...
declare module "@package/net/minecraft/network/protocol/common/custom" {
     ...
     */
    export type $BrainDebugPayload$BrainDump_ = { angerLevel?: number, pos?: $Vec3_, gossips?: $List_<string>, pois?: $Set_<$BlockPos_>, profession?: string, wantsGolem?: boolean, activities?: $List_<string>, name?: string, maxHealth?: number, uuid?: $UUID_, inventory?: string, path?: $Path, memories?: $List_<string>, id?: number, potentialPois?: $Set_<$BlockPos_>, xp?: number, health?: number, behaviors?: $List_<string>,  } | [angerLevel?: number, pos?: $Vec3_, gossips?: $List_<string>, pois?: $Set_<$BlockPos_>, profession?: string, wantsGolem?: boolean, activities?: $List_<string>, name?: string, maxHealth?: number, uuid?: $UUID_, inventory?: string, path?: $Path, memories?: $List_<string>, id?: number, potentialPois?: $Set_<$BlockPos_>, xp?: number, health?: number, behaviors?: $List_<string>, ];
     ...
     */
    export type $BeeDebugPayload$BeeInfo_ = { goals?: $Set_<string>, travelTicks?: number, flowerPos?: $BlockPos_, pos?: $Vec3_, hivePos?: $BlockPos_, blacklistedHives?: $List_<$BlockPos_>, id?: number, path?: $Path, uuid?: $UUID_,  } | [goals?: $Set_<string>, travelTicks?: number, flowerPos?: $BlockPos_, pos?: $Vec3_, hivePos?: $BlockPos_, blacklistedHives?: $List_<$BlockPos_>, id?: number, path?: $Path, uuid?: $UUID_, ];
     ...
     */
    export type $PathfindingDebugPayload_ = { maxNodeDistance?: number, entityId?: number, path?: $Path,  } | [maxNodeDistance?: number, entityId?: number, path?: $Path, ];
     ...
     */
    export type $WorldGenAttemptDebugPayload_ = { pos?: $BlockPos_, red?: number, blue?: number, scale?: number, alpha?: number, green?: number,  } | [pos?: $BlockPos_, red?: number, blue?: number, scale?: number, alpha?: number, green?: number, ];
     ...
     */
    export type $GameTestAddMarkerDebugPayload_ = { text?: string, durationMs?: number, color?: number, pos?: $BlockPos_,  } | [text?: string, durationMs?: number, color?: number, pos?: $BlockPos_, ];
