...
declare module "@package/net/minecraft/server/packs/repository" {
    ...
    export class $PackRepository implements $PackRepositoryAccessor {
        ...
        handler$ghp000$fabric_resource_loader_v0$construct(arg0: $RepositorySource_[], arg1: $CallbackInfo): void;
     ...
     */
    export type $Pack$Metadata_ = { requestedFeatures?: $FeatureFlagSet, description?: $Component_, overlays?: $List_<string>, compatibility?: $PackCompatibility_, isHidden?: boolean,  } | [requestedFeatures?: $FeatureFlagSet, description?: $Component_, overlays?: $List_<string>, compatibility?: $PackCompatibility_, isHidden?: boolean, ];
