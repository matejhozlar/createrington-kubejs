...
declare module "@package/net/neoforged/neoforge/client" {
    ...
    export class $ChunkRenderTypeSet implements $Iterable<$RenderType>, $ChunkRenderTypeSetAccessor$1, $ChunkRenderTypeSetAccessor, $ExtendedChunkRenderTypeSet {
        ...
        static create$sodium_$md$66668e$2(arg0: $BitSet): $ChunkRenderTypeSet;
        sinytra$firstLayer(): $RenderType;
        static setChunkRenderTypesList$aeronautics_$md$66668e$0(arg0: $List_<any>): void;
        static setChunkRenderTypes$aeronautics_$md$66668e$1(arg0: $RenderType[]): void;
        spliterator(): $Spliterator<$RenderType>;
        forEach(arg0: $Consumer_<$RenderType>): void;
        getBits(): $BitSet;
        [Symbol.iterator](): Iterator<$RenderType>
        get empty(): boolean;
        static set chunkRenderTypesList$aeronautics_$md$66668e$0(value: $List_<any>);
        static set chunkRenderTypes$aeronautics_$md$66668e$1(value: $RenderType[]);
        get bits(): $BitSet;
    }
