...
declare module "@package/net/neoforged/neoforge/registries" {
    ...
    export class $DataMapLoader extends $ContextAwareReloadListener {
        apply(): void;
    ...
    export class $DataPackRegistriesHooks implements $DataPackRegistriesHooksAccessor {
        ...
        static set_DATA_PACK_REGISTRIES$connector_$md$66668e$0(arg0: $List_<any>): void;
        /**
        ...
        static set_DATA_PACK_REGISTRIES_VIEW$connector_$md$66668e$1(arg0: $List_<any>): void;
        static get syncedCustomRegistries(): $Set<$ResourceKey<$Registry<never>>>;
        static set _DATA_PACK_REGISTRIES$connector_$md$66668e$0(value: $List_<any>);
        ...
        static set _DATA_PACK_REGISTRIES_VIEW$connector_$md$66668e$1(value: $List_<any>);
    }
    ...
    export class $NeoForgeRegistriesSetup implements $NeoForgeRegistriesSetupAccessor {
        ...
        static invokeModifyRegistries$connector_$md$66668e$0(arg0: $ModifyRegistriesEvent): void;
        constructor();
    ...
    export class $RegistryManager implements $RegistryManagerAccessor {
        ...
        static invokeTrackModdedRegistry$fabric_registry_sync_v0_$md$66668e$0(arg0: $ResourceLocation_): void;
    ...
    export class $NewRegistryEvent extends $Event implements $IModBusEvent, $NewRegistryEventNeoForgeAccessor {
        ...
        static callInit$puzzleslib_$md$66668e$0(): $NewRegistryEvent;
