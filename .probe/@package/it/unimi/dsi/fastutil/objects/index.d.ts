...
declare module "@package/it/unimi/dsi/fastutil/objects" {
    ...
    export class $Object2ObjectArrayMap<K, V> extends $AbstractObject2ObjectMap<K, V> implements $Serializable, $Cloneable {
        clone(): $Object2ObjectArrayMap<K, V>;
        object2ObjectEntrySet(): $Object2ObjectMap$FastEntrySet<K, V>;
        values(): $ObjectCollection<V>;
        keySet(): $Set<K>;
        constructor(arg0: $Object[], arg1: $Object[], arg2: number);
        constructor(arg0: $Map_<K, V>);
        constructor(arg0: $Object2ObjectMap<K, V>);
    ...
    export class $Object2ObjectMap$FastEntrySet<K, V> {
    }
    export interface $Object2ObjectMap$FastEntrySet<K, V> extends $ObjectSet<$Object2ObjectMap$Entry<K, V>> {
        fastForEach(arg0: $Consumer_<$Object2ObjectMap$Entry<$Object2ObjectMap$Entry<K, V>, V>>): void;
        fastIterator(): $ObjectIterator<$Object2ObjectMap$Entry<$Object2ObjectMap$Entry<K, V>, V>>;
    }
