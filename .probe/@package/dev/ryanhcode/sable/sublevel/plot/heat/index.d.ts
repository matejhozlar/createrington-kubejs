...
import { $SubLevelHeatMapManagerAccessor } from "@package/dev/ryanhcode/shipregistry/mixin";
...
declare module "@package/dev/ryanhcode/sable/sublevel/plot/heat" {
    ...
    export class $SubLevelHeatMapManager implements $SubLevelHeatMapManagerAccessor {
        tick(): void;
        ...
        shipregistry$isSplitComplete(): boolean;
