...
import { $IPlayerPartySystemRegisterAPI, $IPlayerPartySystemRegisterAPI_ } from "@package/xaero/pac/common/server/parties/system/api/v2";

declare module "@package/xaero/pac/common/event/api/v2" {
